...
<head>
    ...
    </script><noscript><img src="https://vk.com/rtrg?p=VK-RTRG-11201-hHU9b" style="position:fixed; left:-999px;"
            alt="" /></noscript><!-- Facebook Pixel Code -->
    <script>
...
<body style="margin:0px; padding: 0px;">
    ...
    <script type="text/javascript">
        ...
        <div>
            <img src="https://top-fwz1.mail.ru/counter?id=3089960;js=na"
                style="border:0;position:absolute;left:-9999px;" alt="Top.Mail.Ru" />
        </div>
    </noscript>
    <!-- //Rating@Mail.ru counter -->
    <!--  -->
    <iframe src="https://shop.mastervision.su/?r=af&p=1878&g=4580&lg=ru" frameborder="0" scrolling="yes" height="100%"
        width="100%"></iframe>
