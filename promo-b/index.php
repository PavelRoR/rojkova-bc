...
<html lang="ru">
  <head>
    ...
    <meta property="og:url" content="https://<?=$url;?>/biology-of-consciousness/promo-b/"/>
  ...
  <body><!-- Yandex.Metrika counter -->
    ...
    <section id="main">
      <div class="container">
        ...
        <h1 class="main-title">Оставьте свои данные, чтобы скачать дополнительные материалы по отношениям и целям. Они помогут вам максимально эффективно работать на уроках. <br/>Более подробно разберем на мастер-классе</h1>
        <div class="mail-container">
          <form class="form form-promo" action="https://shop.mastervision.su/?r=personal/newsletter/data/add&amp;id=3568&amp;lg=ru" method="post" enctype="application/x-www-form-urlencoded" accept-charset="UTF-8">
            <div class="inputrow">
              <div class="inputblock">
                <input type="hidden" value="1" name="required_fields[phone_number]"/>
                <input class="input input-mail" name="Contact[phone_number]" type="text" placeholder="Ваш телефон"/>
              </div>
            </div>
            <button class="button button-form-main" type="submit">Забрать доп.материалы <br/>и завершить регистрацию</button>
            <div class="clearfix"></div>
            <p class="alert-message"></p>
            <div class="checking">
              <input class="check" type="checkbox" id="check" checked="checked"/>
              <label class="check-label" for="check">Я согласен с <a href="javascript:void(0);" data-toggle="modal" data-target="#myPolitics"> условиями обработки персональных данных</a> по 152 - Ф3</label>
            </div>
            <div style="display: none;">
              ...
              <input type="hidden" name="formVc" value="2289045558"/>
            </div>
          </form>
